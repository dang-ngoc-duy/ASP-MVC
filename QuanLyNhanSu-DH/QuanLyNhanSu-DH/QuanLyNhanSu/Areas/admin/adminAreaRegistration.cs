...
namespace QuanLyNhanSu.Areas.admin
{
    public class adminAreaRegistration : AreaRegistration
    {
        ...
        public override void RegisterArea(AreaRegistrationContext context)
        {
            ...
            context.MapRoute(
                "admin_sua_luong",
                "admin/quan-ly-luong/sua-bang-luong/{id}",
            ...
            context.MapRoute(
               "admin_tang_luong",
               "admin/quan-ly-luong/qua-trinh-tang-luong/{id}",
            ...
            context.MapRoute(
                "admin_sua_phong_ban",
                "admin/quan-ly-phong-ban/sua-thong-tin-phong-ban/{id}",
            ...
            context.MapRoute(
                "admin_sua-thong-tin",
                "admin/quan-ly-nhan-vien/sua-thong-tin/{id}",
            ...
            context.MapRoute(
                ...
                "admin/quan-ly-nhan-vien/qua-trinh-cong-tac/{id}",
                new { Controller = "QuanLyUser", action = "QuaTrinhCongTac", id = UrlParameter.Optional }
            );
            context.MapRoute(
                "admin_qua-trinh-hoc-tap",
                "admin/quan-ly-nhan-vien/qua-trinh-hoc-tap/{id}",
                new { Controller = "QuanLyUser", action = "QuaTrinhHoc", id = UrlParameter.Optional }
            );
            //========================quan ly khen thuong=================================
            context.MapRoute(
                "admin_quan-ly-khen-thuong",
                "admin/quan-ly-khen-thuong",
                new { Controller = "KhenThuong", action = "Index", id = UrlParameter.Optional }
            );
            context.MapRoute(
                "admin_khen-thuong",
                "admin/quan-ly-khen-thuong/khen-thuong",
                new { Controller = "KhenThuong", action = "khen", id = UrlParameter.Optional }
            );
